...
1. Clone this repository:
   ...
   ```bash
   git clone https://github.com/nishanth1596/typemaster-keyboard-landing-page.git
   ```

2. Navigate into the project directory:
   cd typemaster-keyboard-landing-page
...
Google Fonts - I used the Barlow Display font from Google Fonts to style the text.
